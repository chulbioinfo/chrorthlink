...
#    GLOBAL_VARIABLE    #
#########################
RefID_list = ["LittleSkate"]#"hg38", "mOrnAna1", "bTaeGut2", "rGopEvg1", "aRhiBiv1", "sAmbRad1", "fGouWil2"]

sID_LIST = ["LittleSkate","ThornySkate","Zebrafish","Chicken","Mouse","Human"]

target_chr_name = "1" # or All
